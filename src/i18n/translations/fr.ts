export const fr = {
  ...
  pricing: {
    ...
    customSetup: 'À partir de 3 000€',
    customMonthly: 'À partir de 599€/mois',
    customFeature1: 'Systèmes IA Personnalisés',
    customFeature2: 'IA Vocale',
    customFeature3: 'Intégrations API',
    customFeature4: 'Automatisation Avancée',
    customFeature5: 'Support Dédié',
    customFeature6: 'Optimisation Continue',
    customCta: 'Planifier une Consultation',
  },
