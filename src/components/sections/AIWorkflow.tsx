...
const STEPS = [
  {
    id: '01',
    en: 'Lead Arrives',
    desc: 'Prospect submits a form, clicks an ad, or sends a message.',
    icon: (
  ...
  },
  {
    id: '02',
    en: 'AI Understands',
    desc: 'Natural language processing captures intent and context in under 2 seconds.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-5 h-5" aria-hidden="true">
  ...
  },
  {
    id: '03',
    en: 'Qualification',
    desc: 'Budget, timeline, and intent scored automatically against your criteria.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-5 h-5" aria-hidden="true">
  ...
  },
  {
    id: '04',
    en: 'Instant Response',
    desc: 'Personalised reply sent within 60 seconds — while competitors are still sleeping.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-5 h-5" aria-hidden="true">
  ...
  },
  {
    id: '05',
    en: 'Meeting Booked',
    desc: 'Calendar synced, invite sent, confirmation delivered — zero human involvement.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-5 h-5" aria-hidden="true">
  ...
  },
  {
    id: '06',
    en: 'Team Notified',
    desc: 'Sales rep receives lead score, context, and talking points before the call.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-5 h-5" aria-hidden="true">
  ...
  },
  {
    id: '07',
    en: 'Client Follow-up',
    desc: 'AI-written sequences nurture the prospect until they\'re ready to close.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-5 h-5" aria-hidden="true">
...
const Step = memo(({ step, index, isLast }: { step: typeof STEPS[0]; index: number; isLast: boolean }) => {
    ...
    <div ref={ref} className="relative flex gap-6 md:gap-8">
      ...
      >
        <div className="flex items-center gap-3 mb-1.5">
          <span className="text-[9px] text-stone-700 tabular-nums font-mono tracking-wider">{step.id}</span>
          <h3 className="text-[14px] font-semibold text-stone-200">{step.en}</h3>
        </div>
        <p className="text-[13px] text-stone-500 leading-[1.75] max-w-[280px]">{step.desc}</p>
      </motion.div>
    </div>
  );
});
        ...
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-28 items-start">
          ...
          <div className="lg:sticky lg:top-32">
            ...
            >
              From first touch
              <br />
              <span className="italic font-light text-stone-500">to closed deal.</span>
            </motion.h2>
            ...
            >
              Every step automated. Every prospect qualified.
              Every meeting confirmed — while your team focuses on closing.
            </motion.p>
